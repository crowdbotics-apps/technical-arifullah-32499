...
## Project Structure
    ...
    ├── technical_arifullah_32499  # Django project configurations
...
1. Clone this repo and `cd technical_arifullah_32499`
...
2. Clone this repo and `cd technical_arifullah_32499`
